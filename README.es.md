...
1. Abre la carpeta [`cards/es/`](cards/es/).
...
| :--- | :--- | :--- | :--- |
| **00** | Cualquier momento | [`cards/es/00-error-rescue.md`](cards/es/00-error-rescue.md) | **Rescate de Errores**: Diagnóstico rápido de 1 línea y snippet mínimo de corrección (ahorra tokens). |
| **01** | Día 1 PM / Día 2 AM | [`cards/es/01-byod-audit-card.md`](cards/es/01-byod-audit-card.md) | **Auditoría BYOD**: Validación de coordenadas en país, chequeo de horizontes/profundidades y matriz pedológica. |
| **02** | Día 2 PM | [`cards/es/02-covariates-card.md`](cards/es/02-covariates-card.md) | **Covariables Ambientales**: Inspección de rásteres SCORPAN, armonización de CRS y extracción de puntos (`dat_cov`). |
| **03** | Día 3 AM | [`cards/es/03-spectra-card.md`](cards/es/03-spectra-card.md) | **Espectroscopía DRS**: Preprocesamiento (`prospectr`: SNV, Savitzky-Golay), calibración y dataset aumentado. |
| **04** | Día 3 PM | [`cards/es/04-qrf-modeling-card.md`](cards/es/04-qrf-modeling-card.md) | **Modelado QRF**: Selección con `Boruta`, entrenamiento con `ranger`/`caret`, métricas `eval.RData` y gráfico 1:1. |
| **05** | Día 4 AM / PM | [`cards/es/05-prediction-opennsis-card.md`](cards/es/05-prediction-opennsis-card.md) | **Mapeo Espacial & OpenNSIS**: Predicción por mosaicos (media e incertidumbre), exportación a COG y metadatos ISO 19139. |
