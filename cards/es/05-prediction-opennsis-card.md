...
- Trained model: `03_outputs/module3/models/ranger_model_{{PROPIEDAD}}.rds`
- Covariate raster stack: `covs`
- Target property: `{{PROPIEDAD_OBJETIVO, ej: SOC}}`
- Country ISO code: `{{CODIGO_PAIS, ej: GTM, CRI, DOM, BLZ, SLV, HND, PAN}}`
- Depth interval: `{{PROFUNDIDAD_SUP, ej: 0}}` to `{{PROFUNDIDAD_INF, ej: 30}}` cm
